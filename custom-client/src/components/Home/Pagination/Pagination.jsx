...
const Pagination = ({ pageNumbers, page, setPage }) => {
  ...
  return (
    <>
      <div
        className={`${styles.page_btns_container} ${styles.desktop_container}`}
      >
      ...
      {/* mobile Pagination */}
      <div
        className={`${styles.page_btns_container} ${styles.mobile_container}`}
      >
        <button title="move" onClick={goToPrevPage} className={styles.page_btn}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            className={`${styles.page_btn} ${styles.active_page}`}
          >
            {page}
          </button>
